...
//  YouTube
//
//  Created by Douglas Moreira on 02/07/19.
...
class VideoCell: BaseCell {
    ...
    let thumbnailImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "pabllo-vittar")
    ...
    let userProfileImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "pabllo-vittar-profile")
    ...
    let subtitleTextView: UITextView = {
        ...
        textView.text = "Pabllo Vittar - 1.640.325 views - 2 years"
